    ...
    render(): React.ReactNode {
        ...
        return (
            <>
                                        ...
                                        <div key={index} className="item-info">
                                            ...
                                            <div className="item-info__details">
                                                <p className="item-info__detail">
                                                    This Star War hero {item.name} has a height of {item.height} cm. 
                                                    {item.gender === "male" ? <span> He</span> : <span> She</span>} was born 
                                                    in {item.birth_year}. </p>
                                            </div>
                                        </div>
                            ...
                            <div className='items'>
                                {planets.map((item, index) => (
                                    <div key={index} className="item-info">
                                        <div className="item-info__name">{item.name}</div>
                                        <div className="item-info__details">
                                            <p className='item-info__detail'>Climate: {item.climate}</p>
                                            <p className='item-info__detail'>Population: {item.population}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                ...
                :
                <div className='items-header'>{ errorMessage ? `${errorMessage}. Please check your network connection 🛜`
                    : 'Loading data... '}</div>  
            }
            </>
        );
